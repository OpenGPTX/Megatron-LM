...
@pytest.mark.parametrize("arg_values", [
    ...
    "2",
     "--data-path",
    str(Path(__file__).absolute().parent.parent.joinpath("resources","dataset/openwebtext_200_text_document")),
    "--tokenizer-type",
     "OpenGPTX-HFTokenizer",
     "--tokenizer-model",
    str(Path(__file__).absolute().parent.parent.joinpath("resources","tokenizer/bpe_tokenizer.json")),
    "--seed",
     "42",
